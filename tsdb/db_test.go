...
func TestMain(m *testing.M) {
	...
	goleak.VerifyTestMain(m, goleak.IgnoreTopFunction("github.com/jmcarp/prometheus-config/tsdb.(*SegmentWAL).cut.func1"), goleak.IgnoreTopFunction("github.com/jmcarp/prometheus-config/tsdb.(*SegmentWAL).cut.func2"))
}
